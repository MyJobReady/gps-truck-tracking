				...
				<div id='loading'>&nbsp;</div>
					<div id="wrapper">
						...
						<div id="content">
							...
							<form method="POST" enctype="application/x-www-form-urlencoded" class="formstyle" action="maps_edittruck.php?ID=<?php echo $truck->ID;?>" id="truck_edit">
								<p>
									<label>Current Driver:</label><br />
									...
									<label>Truck Driver GPS Display Name :</label><br />
